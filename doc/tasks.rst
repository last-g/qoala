...
* <tasks/example.xml> - пример XML таска
* example.py - пример script таска
...
* <scriptname> series - печатает идентификатор категории на stdout, должен совпадать с таковым и id
