...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teams_team', (
            ...
            ('token', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True)),
        ))
        db.send_create_signal('teams', ['Team'])

        # Adding M2M table for field groups on 'Team'
        m2m_table_name = db.shorten_name('teams_team_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['teams.team'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['team_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'Team'
        m2m_table_name = db.shorten_name('teams_team_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['teams.team'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('teams_team_groups'))

        # Removing M2M table for field user_permissions on 'Team'
        db.delete_table(db.shorten_name('teams_team_user_permissions'))
